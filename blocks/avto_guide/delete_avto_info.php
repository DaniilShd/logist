...
//Удаляем из справочника (avto) информацию об автмобиле
$id = $_GET[id];

$delete_avto = R::load('avto', $id);
R::trash($delete_avto);
...
?>
<div id="<?php echo $_GET['number_id_request_avto'];?>" class="number_id_request_avto" style="display: none"></div>
<table class="table table-sm table-hover table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">Грузоп.</th>
                    <th scope="col">Кузов</th>
                    <th scope="col">Закупка</th>
                    <th scope="col">Водителя №1</th>
                    <th scope="col">Номер №1</th>
                    <th scope="col">Водителя №2</th>
                    <th scope="col">Номер №2</th>
                    <th scope="col">Водителя №3</th>
