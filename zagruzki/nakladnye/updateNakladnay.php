...
if ($_GET["name_row"] == "tovar_prinyt"){
    R::exec('UPDATE `zagruzkanakladnay` SET `tovar_prinyt` = :tovar_prinyt WHERE id = :id', [
        'id' => $id,
        'tovar_prinyt' => $_GET["value"]
      ]);
      if ($_GET["value"] == 1) {
        R::exec('UPDATE `zagruzkanakladnay` SET `tovar_prinyt_data` = :tovar_prinyt_data WHERE id = :id', [
            'id' => $id,
...
if ($_GET["name_row"] == "tovar_ne_prinyt"){
  R::exec('UPDATE `zagruzkanakladnay` SET `tovar_ne_prinyt` = :tovar_ne_prinyt WHERE id = :id', [
      'id' => $id,
      'tovar_ne_prinyt' => $_GET["value"]
    ]);
    if ($_GET["value"] == 1) {
      R::exec('UPDATE `zagruzkanakladnay` SET `tovar_ne_prinyt_data` = :tovar_ne_prinyt_data WHERE id = :id', [
          'id' => $id,
